---
title: "Data descriptor publication (Imbert et al., 2021): figures and tables"
author: "Etienne Thevenot (ProMetIS consortium)"
date: "`r doc_date()`"

vignette: >
  %\VignetteIndexEntry{ImbertEtAl_2021_ScientificData}
...
```{r metabosets_postprocessing_technical_validation, message=FALSE, warning=FALSE}
...
```{r metabosets_quality_scoreplots, message=FALSE, warning=FALSE}
